...
salaries$salary_2018<- salaries_2017+adjustments
print(salaries)
...
print(salaries[salaries$employees == "Employee 57", "salary_2018"])
...
read.csv("my_new_file.csv", stringsAsFactors = FALSE)
print(getwd())
setwd("C:/Users/ASUS/Desktop/book-exercises/chapter-10-exercises/exercise-2/data")
