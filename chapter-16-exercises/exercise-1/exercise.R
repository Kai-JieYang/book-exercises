...
ggplot(data=diamond_sample, mapping = aes(x=carat, y=price,color=clarity))+
geom_point()
...
ggplot(data=diamond_sample, mapping = aes(x=carat, y=price))+
    geom_point(color="blue")

# Draw a scatter plot for `diamonds_sample` of `price` by `carat`, where each
# point has an aesthetic _shape_ based on the diamond's `cut`.
ggplot(data=diamond_sample, mapping = aes(x=carat, y=price,shape=cut))+
    geom_point()
